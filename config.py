...
START_MSG = environ.get("START_MSG", FilmZone.START_MSG)
...
SET_SPEL_M = environ.get("SPELL_MODE_TEXT", FilmZone.SPELL_CHECK)
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", None))
DATABASE_URI = environ.get("DATABASE_URI", None)
FORCE = environ.get('FORCES_SUB')
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", FilmZone.FILE_CAPTIONS)
DEV_NAME = environ.get("DEV_NAME", "DarkLord")
...
DATABASE_NAME = environ.get("DATABASE_NAME", 'FilmZone_Robot')
