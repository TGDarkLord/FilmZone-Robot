...
@FilmZone_Robot.on_message(Worker.command('delete') & Worker.user(ADMINS))
...
@FilmZone_Robot.on_message(Worker.command('deleteall') & Worker.user(ADMINS))
...
@FilmZone_Robot.on_callback_query(Worker.regex(r'^autofilter_delete'))
