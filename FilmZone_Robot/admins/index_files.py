...
from pyrogram import Client as filmzone_robot, filters as filter
from pyrogram.errors import FloodWait
from pyrogram.errors.exceptions.bad_request_400 import ChannelInvalid, ChatAdminRequired, UsernameInvalid, UsernameNotModified
from config import ADMINS, LOG_CHANNEL
from FilmZone_Robot.database.autofilter_db import save_file
...
@filmzone_robot.on_message((filter.forwarded | (filter.regex("(https://)?(t\.me/|telegram\.me/|telegram\.dog/)(c/)?(\d+|[a-zA-Z_0-9]+)/(\d+)$")) & filter.text ) & filter.private & filter.incoming)
...
@filmzone_robot.on_message(filter.command('setskip') & filter.user(ADMINS))
