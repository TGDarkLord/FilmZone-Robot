...
from FilmZone_Robot.database._utils import send_msg
...
@filmzone_robot.on_message(filter.private & filter.command(["broadcast", "send"]) & filter.user(ADMINS) & filter.reply)
